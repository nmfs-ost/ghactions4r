...
# use_calc_cov_summaries() works
    ...
    Output
       ...
       [9] "  workflow_dispatch:"                                                                                                                     
      [10] ""                                                                                                                                         
      [11] "# limits permissions to write, as the common use case is for pull requests;"                                                              
      [12] "# this means certain options may not work, but makes the workflow more secure"                                                            
      [13] "permissions:"                                                                                                                             
      [14] "  pull-requests: write"                                                                                                                   
      [15] ""                                                                                                                                         
      [16] "jobs:"                                                                                                                                    
      [17] "  call-workflow:"                                                                                                                         
      [18] "    uses: nmfs-ost/ghactions4r/.github/workflows/calc-cov-summaries.yml@main"                                                             
...
# use_calc_cov_summaries() works with use-public-rspm = FALSE and depends_on_quarto = TRUE
    ...
    Output
      ...
      [18] "    uses: nmfs-ost/ghactions4r/.github/workflows/calc-cov-summaries.yml@main"                                                             
      [19] "    with:"                                                                                                                                
      [20] "      depends_on_quarto: true"                                                                                                            
      [21] "      use-public-rspm: false"                                                                                                             
